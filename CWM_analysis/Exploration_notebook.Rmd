...
for (group in list_groups){
  ...
  # Load dataset
  if (weight == FALSE){
    CWM = fread(paste0('/Users/Margot/Desktop/Research/Senckenberg/Project_Ecosystem_strat/Analysis/Data/CWM_data/CWM_',group, '_noweight.csv'))
...
all_cwm_melt = melt.data.table(all_cwm, id.vars = c('Plot', env_var, 'Grazing', 'Mowing', 'Fertil', 'Fertilisation', 'Disturbance','LUI'))
all_cwm_melt_uncorr = melt.data.table(all_cwm_uncorr, id.vars = c('Plot', env_var, 'Grazing', 'Mowing', 'Fertil','Fertilisation', 'Disturbance', 'LUI'))
...
# scale everything
all_cwm_melt_all[, c(env_var[env_var != 'Region'], 'Grazing', 'Mowing', 'Fertil','Fertilisation', 'Disturbance', 'LUI',  'value', 'value_uncorr') := lapply(.SD, function(x){as.numeric(scale(x))}), .SDcols = c(env_var[env_var != 'Region'], 'Grazing', 'Mowing', 'Fertil','Fertilisation', 'Disturbance', 'LUI', 'value', 'value_uncorr'), by = variable]
