...
Hypothesis_table$Group_f = factor(Hypothesis_table$Group_f, levels=c( 'arthropods_above_carni','birds', 'bats',                                                         'plants','arthropods_above_herb','butterflies',
...
prop = c( plant = pca_plants_all$PCA$eig[,2][ 1],
        Arth_herb = pca_arthro_herb$PCA$eig[,2][1],
