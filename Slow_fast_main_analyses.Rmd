...
labels_arthro_herb =  c("Dispersal"     ,        "Body size" ,       "Generalism"  ,        "Gen. per year"  )
...
labels_arthro_below_herb =  c("Dispersal", "Body size" , 'Generalism')
...
labels_but =  c("Generalism",  "Size" , "Voltinism" , "Hibernation stage",  "Flight period"     )
...
ggsave(plot = pca_plants_all$plot12,file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Plant_com_pca.pdf', sep = ''), width = 6, height = 6)
...
ggsave(plot = pca_mic$plot12, file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/bact_fungi_OCm_pca.pdf', sep = ''), width = 6, height = 6)
```
...
ggsave(plot = pca_arthro_herb$plot12, file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Arthro_herb_AG_com_pca.pdf', sep = ''), width = 6, height = 6)
...
ggsave(plot = pca_arthro_herb_below$plot12,file =
         paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Arthro_herb_BG_com_pca.pdf', sep = ''), width = 6, height = 6)
...
ggsave(plot = pca_but$plot12, file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Butterflies_com_pca.pdf', sep = ''), width = 6, height = 6)
```
...
ggsave(plot = pca_arthro_pred$plot12, file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Arthro_oc_com_pca.pdf', sep = ''), width = 6, height = 6)
...
ggsave(plot = pca_arthro_pred_below$plot12,file =
         paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Arthro_oc_BG_com_pca.pdf', sep = ''), width = 6, height = 6)
```
...
ggsave(plot = pca_birds_all$plot12,file =  paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Birds_i_com_pca.pdf', sep = ''), width = 6, height = 6)
```
...
ggsave(plot = pca_mites_all$plot12,file = 
         paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Mites_com_pca.pdf', sep = ''), width = 6, height = 6)
```
...
ggsave(plot = pca_coll_all$plot12, file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Coll_com_pca.pdf', sep = ''), width = 6, height = 6)
...
ggsave(plot = pca_bats_all$plot12,file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/Bats_com_pca.pdf', sep = ''), width = 6, height = 6)
```
...
layout_fun = matrix(c(c(2, 1, 0),
 ...
 png(file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/SEM_functions.png', sep = ''), width = 600, #height = 400
     )
 plot(p)
 dev.off()
...
layout_fun = matrix(c(c(2, 1, 0),
 ...
 png(file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/SEM_functions_all_traits.png', sep = ''), width = 600, height = 400)
 plot(p_allTraits)
 dev.off()
...
layout_fun = matrix(c(c(2, 1, 0),
 ...
 png(file = paste('Results/Envcorr_', env_corr, '/weight_', weight,'/SEM_functions_FB.png', sep = ''), width = 600, height = 400)
 plot(p_FB)
 dev.off()
```
...
for (t2 in unique(all_cwm_lui_not_imputed$traitName2)){
    ...
    rsq = rsq/sum(rsq)
    #rsqp = rsq.partial(mod)
    #rsq = rsqp$partial.rsq
    #names(rsq) = rsqp$variable
    r = rsq(mod)
