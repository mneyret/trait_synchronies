...
It is provided "as is", without any warranty. It should be run after all CWM tables are created (Create_CWM_table.R).
...
# Load and format environment data
...
test = mice::complete(mice(data_cast, seed=101))
...
varpart_results = rbind(varpart_results,
                        data.table(Group=group, 
                                   ...
                                   Residuals = round(1-mod$part$fract$Adj.R.squared[3], 3)))
```
...
# Adding values
Hypothesis_table[Group != '', c("P", "Est", "CI","CI_low", 'CI_high', 'N', 'Mowing', 'Grazing', 'Fertil' ) :=
  list(
