...
knitr::opts_knit$set(root.dir = "Analysis/Code")
```
...
This script loads CWM, environmental covariates and ecosystem functions data to
  ...
  - test the relaiton between trait slow-fast and ecosystem functions slow-fast axes.
  

Parameters: environmental correction is `r env_corr`; weighting for abundances is  `r weight`.
